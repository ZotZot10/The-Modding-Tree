...
addLayer("Matter", {
    startData() { return {                  // startData is a function that returns default data for a layer. 
        ...
        CUM: new Decimal(0),             // "points" is the internal name for the main resource of the layer.
    }},

    color: "Blue",                       // The color for this layer, which affects many elements.
    resource: "Matter",            // The name of this layer's main prestige resource.
    row: 1,                                 // The row this layer is on (0 is the first row).

    baseResource: "Condensed Unknown Matter",                 // The name of the resource your prestige gain is based on.
    baseAmount() { return player.CUM},  // A function to return the current amount of baseResource.
